...
(define (read-syntax source-name in-port)
  ...
  (define parse-tree (parse source-name (turtle-make-tokenizer in-port)))
  ...
  #`(module turtle-module rdf/turtle/expander  ; TODO this is one place that we swap could out backends
